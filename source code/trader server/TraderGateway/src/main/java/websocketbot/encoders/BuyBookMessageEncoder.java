...
public class BuyBookMessageEncoder implements Encoder.Text<BuyBookMessage>{
    ...
    public String encode(BuyBookMessage buyBookMessage) throws EncodeException {
        ...
        jsonGen.writeStartObject().write("type", "buybook").write("buybook", buyBookMessage.getBuyBook()).write("brokerid",buyBookMessage.getBrokerid()).write("productCode",buyBookMessage.getProductCode()).write("price",buyBookMessage.getPrice()).writeEnd();
        jsonGen.flush();
