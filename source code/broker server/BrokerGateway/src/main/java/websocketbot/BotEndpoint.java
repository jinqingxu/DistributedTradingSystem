...
public class BotEndpoint {
    ...
    public void sendAll(String buy, String sell,String productCode, Double price, Timestamp time){

        BuyBookMessage buyBookMessage=new BuyBookMessage(buy,productCode,price.toString(),time.toString());
        helpsendAll(buyBookMessage);
        SellBookMessage sellBookMessage=new SellBookMessage(sell,productCode);
