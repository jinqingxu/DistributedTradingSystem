    ...
    public Message decode(String string) throws DecodeException {
        ...
        if (willDecode(string)) {
            if(messageMap.get("type").equals("buybook")){
                msg=new BuyBookMessage(messageMap.get("buybook"),messageMap.get("productCode"),messageMap.get("price"),messageMap.get("time"));
            }
            else if(messageMap.get("type").equals("sellbook")){
                msg=new SellBookMessage(messageMap.get("sellbook"),messageMap.get("producycode"));
